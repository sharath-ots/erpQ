...
import DateRangePicker from '@/shared-ui/components/base/DateRangePicker';
        ...
        <Paper background={1} sx={{ px: { xs: 3, md: 5 }, py: 3 }}>
            <Stack
                ...
                sx={{
                    ...
                    alignItems: 'center', // Centers items horizontally on mobile, vertically on desktop
                    justifyContent: 'center' // Centers the whole stack horizontally on desktop
                }}
            >
                <div>
