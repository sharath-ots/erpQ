...
} from 'data/kanban/kanban/createBoard';
import { backgroundOptionFormSchema } from 'components/crm-board/kanban/create-board/steps/Background/Background';
import { basicInfoFormSchema } from 'components/crm-board/kanban/create-board/steps/BasicInfo';
import { columnInfoSchema } from 'components/crm-board/kanban/create-board/steps/ColumnStage/ColumnStage';
import { labelInfoFormSchema } from 'components/crm-board/kanban/create-board/steps/LabelInfo';
import { newTeamFormSchema } from 'components/crm-board/kanban/create-board/steps/TeamInvite/NewTeamTabPanel';
