...
import LeadDetailsSideHeader from './LeadDetailsSideHeader';
            ...
            {data.map((item, idx) => (
                <Box key={idx} sx={{ wordBreak: 'break-word' }}>
                    <Typography
                        ...
                        sx={{ display: 'block', mb: 0.5, textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: 600 }}
                    >
                        {item.label}
                    </Typography>
                    {item.value}
...
const LeadDetailsSide = ({ leadId }) => {
    ...
    return (
        <Stack direction="column" spacing={4}>
            <LeadDetailsSideHeader leadName={rawLeadData?.lead_name} leadCRMId={leadId} />
...
export default LeadDetailsSide;