...
/**
 * CRM home: metrics + quick open to ERPNext desk + DocType explorer.
 * @param {object} props
 * @param {string} [props.deskBaseUrl] — public ERPNext origin, e.g. https://cityqerp.ortusolis.in
 * @param {string} props.apiBase — apiGate origin
 * @param {() => string | null} props.getAccessToken
 */
export function CrmqDashboard({ deskBaseUrl, apiBase, getAccessToken }) {
