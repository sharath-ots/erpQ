...
export const userEngagementChartData = {
  newUser: {
    actual: [
...
export const topCampaignsChartData = [
  {
    campaign: 'Search',
    users: 112000,
  },
...
export const userByCountryData = [
  {
    id: 1,
    country: {
      name: 'Nepal',
