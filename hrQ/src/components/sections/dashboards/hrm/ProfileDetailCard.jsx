...
const ProfileDetailCard = ({ title, value }) => {
  ...
  return (
    <Paper
      component={Stack}
      direction="column"
      sx={{ px: { xs: 3, md: 5 }, py: 2, height: 1, alignItems: "flex-start", justifyContent: "center" }}
    >
      ...
      {typeof value === "object" ? (
        ...
        <Typography
          variant="subtitle2"
          sx={{ color: "text.secondary", textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap", width: 1 }}
        >
