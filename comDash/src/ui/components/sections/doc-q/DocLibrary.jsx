...
export default function DocLibrary({ view = "all", title, showActions = false }) {
  const config = {
    all: {
      ...
      description: "Managed documents you can access.",
      view: null,
    },
    my: {
      title: title || "My documents",
      description: "Documents you authored — drafts, in review, and approved.",
      view: "my",
    },
    changes_requested: {
    ...
    shared_with_me: {
      ...
      description: "Documents other people have shared with you.",
      view: "shared_with_me",
      emptyHint: "Nothing has been shared with you yet.",
    },
    shared_by_me: {
      title: title || "Shared by me",
      description: "Documents you have shared with other people.",
      view: "shared_by_me",
